...
namespace Optsol.Components.Service
{
        ...
        where TEntity: IAggregateRoot<TKey>
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetByIdAsync<TViewModel>(TKey id)
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllAsync<TViewModel>()
            where TViewModel: BaseViewModel
        {
        ...
        [HttpPost("{viewModel}")]
        public async Task<IActionResult> InsertAsync<TViewModel>(TViewModel viewModel)
            where TViewModel: BaseViewModel
        {
            if(viewModel == null)
                return NotFound();
        ...
        public async Task<IActionResult> UpdateAsync<TViewModel>(TViewModel viewModel)
            where TViewModel: BaseViewModel
        {
            if(viewModel == null)
                return NotFound();
