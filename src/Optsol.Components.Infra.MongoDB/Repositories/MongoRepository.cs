...
public class MongoRepository<TEntity, TKey> : IBaseRepository<TEntity, TKey>
    where TEntity : class, IAggregateRoot<TKey>
{
    ...
    private ISearchResult<TEntity> GetAll<TSearch>(ISearchRequest<TSearch> searchRequest) where TSearch : class
    {
